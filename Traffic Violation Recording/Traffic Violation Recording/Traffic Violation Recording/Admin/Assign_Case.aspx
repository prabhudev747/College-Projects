...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style8" frame="box" style="border: 2px solid #0066FF; width: 725px;">
        <tr>
            <td class="style7" colspan="2">
                Complaint Assigning Details</td>
        </tr>
        <tr>
            <td class="auto-style10">
                Complaint Assigned To Officers</td>
            <td>
        ...
        <tr>
            <td class="auto-style10">
                Date of Assign</td>
            <td>
                <asp:TextBox ID="txtDateAssign" runat="server" TextMode="Date" Width="182px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style10">
        ...
        <tr>
            <td class="auto-style10">
                Complaint No.</td>
            <td>
                <asp:TextBox ID="txtComplaintNo" runat="server" ReadOnly="True" OnTextChanged="txtComplaintNo_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style10">
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="ImgbtnSubmit" runat="server" Height="42px" 
                    ImageUrl="~/images/SubmitButton.png" onclick="ImgbtnSubmit_Click" Width="112px" />
            </td>
        </tr>
        <tr>
            <td class="auto-style11">
