    ...
    public partial class Public : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click1(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string query = "Select Username,Password from PublicRegister_tbl where Username='" + txtUsername.Text + "' and Password='" + txtPassword.Text + "' ";
                ...
                if (dr.HasRows)
                {
                    ...
                    Response.Redirect("~/Public/Complaint_Form.aspx");
                }
