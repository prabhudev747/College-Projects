...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="style4">
                &nbsp;</td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtComplaintNo" ErrorMessage="Enter Complaint No." ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style3">
