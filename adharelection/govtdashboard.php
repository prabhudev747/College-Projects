      ...
      <div class="app-sidebar__user">
	   ...
	   <li><a class="app-menu__item" href="viewcandidate.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">VIEW CANDIDATE</span></a></li>
        ...
        <li><a class="app-menu__item" href="varify.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Varify User </span></a></li>
			   ...
			   <!--  <li><a class="app-menu__item " href="logout.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">LOGOUT</span></a></li>
      </ul>
   --> </aside>
...
?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">ELECTION INFORMATION </h3>
            <ul>
			<p><h5>The Election Commission of India is preparing to pitch for the mandatory, legally backed, linking of voter IDs with the Aadhaar number, ET has learnt. 
            ...
            <div class="tile-body">
              <form class="form-horizontal" action="" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['ename']; ?>" type="text" readonly >
                  </div>
                </div>
				<div class="form-group row">
                  <label class="control-label col-md-3">E-TYPE</label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['etype']; ?>" type="text"  readonly>
                  </div>
                </div>
				<div class="form-group row">
                  <label class="control-label col-md-3">E-DATE</label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['edate']; ?>" type="text"  readonly>
                  </div>
                </div>
				<div class="form-group row">
                  <label class="control-label col-md-3">START TIME</label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['stime']; ?>" readonly>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">END TIME</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8"  VALUE="<?php echo $data['dtime']; ?>" readonly>
                  </div>
                </div>
