...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="">Pocket Clinic</a>
...
$result = mysql_query("SELECT * FROM businessinfo where userID='$a'"); // selecting data through mysql_query()
