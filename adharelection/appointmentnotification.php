...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">ADHAR-ELE</a>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="">TENDER REQUEST FROM COMPANIES</a></li>
        </ul>
      </div>
	 ...
	 //error_reporting(0);
	 $a=$_SESSION['username'];
	 $query="SELECT * from companyinfo where user_id in(select user_id from send_request where sender_id='$a')";
        ...
        <div class="col-md-12">
          ...
          <button class="close" type="button" data-dismiss="alert">×</button>
            <div class="table-responsive">
              <table class="table">
			  <h3 class="tile-title"><?php echo $data['first_name']; ?> <?php echo $data['second_name']; ?></h3>
				
				 <label class="col-form-label col-form-label-lg" for="inputLarge"><?php echo $data['company_name']; ?> </label>
				 <p>Phone :<a href="https://www.truecaller.com/search/in/=<?php $data['phone']; ?>" target="_blank"><?php echo $data['phone']; ?></a>
                ...
                <tbody>
				  ...
				  <tr>
					...
					<td><form class="row"  action="userdb2" method="post"> 
					
					<input  class="form-control"type="text" name="p1" value="<?php echo $_SESSION['username']; ?>"  readonly /></td>
					<td><input class="form-control" type="text" name="p2" value="<?php echo $data['user_id']; ?>" readonly  /></td>
					<td><input class="form-control" type="text" name="p3"   /></td>
					<td>
					
					
					<button class="btn btn-primary" type = "submit" >SEND CONFIRMATION</button></td>
