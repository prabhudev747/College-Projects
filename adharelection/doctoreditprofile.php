    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
	   ...
	   <li><a class="app-menu__item" href="appointmentnotification.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">TENDER REQUEST</span></a></li>
        ...
        <li><a class="app-menu__item active" href="doctoreditprofile.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">UPDATE PROFILE</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6">
		 ...
		 <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Update Tender Info</h3>
            <div class="tile-body">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPJaq8h4L3_LgeKhYA9c3ZS6rLuQF75gU&libraries=places&callback=initAutocomplete"
	   ...
	   <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "INSERT INTO doctorprofile (firstname,lastname,clinicname,phonenumber,doctorid,address,workexperience,tfrom,tto,specilisation,city) VALUES ('".$_POST["p1"]."','".$_POST["p2"]."','".$_POST["p3"]."','".$_POST["p4"]."','".$_POST["p5"]."','".$_POST["p6"]."','".$_POST["p7"]."','".$_POST["p8"]."','".$_POST["p9"]."','".$_POST["pp"]."','".$_POST["ppp"]."')";
