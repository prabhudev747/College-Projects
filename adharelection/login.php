...
<html lang="en">
  ...
  <?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `voter` WHERE adhar='$username'";
		$result = mysqli_query($con,$query) or die(mysql_error());
		$rows = mysqli_num_rows($result);
        if($rows==1){
			$_SESSION['username'] = $username;
			header("Location: viewele.php"); // Redirect user to index.php
            }else{
				echo "<div class='form'><h3>Adhar Number is Invalid </h3><br/>Click here to <a href='login.php'>Login</a></div>";
				}
    }else{
...
?>
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>ENTER AADHAAR NUMBER</h1>
...
<input type="text" name="username" placeholder="Enter Aadhaar Number" required />
