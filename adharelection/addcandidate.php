      ...
      <div class="clearfix"></div>
        <div class="col-md-12">
          ...
          <button class="close" type="button" data-dismiss="alert">×</button>
			...
			<form class="form-horizontal" action="addcanddb.php" method="post">             
			 <table class="table">
			   <thead>
                  <tr>
                ...
                <tbody>
				  ...
				  <tr>
					...
					<td><input type="file"  name="p4" required></td>
						<td><input type="text"  name="p44" required></td>
					<td><input type="text" maxlength="12" minlength="12"  name="p5" required></td>
					
                    <td><button class="btn btn-primary" type = "submit" >ADD CANDIDATE</button></td>
                  </tr>
