    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          ...
          <?php
		  $a=$_SESSION['username'];
$query="SELECT candidateid,count(*)FROM vote group by candidateid";
	 //error_reporting(0);
      ...
      <div class="row">
		...
		<form action="deleteresult.php" method="POST">
                 ...
                 <div class="form-group row">
                  <label class="control-label col-md-3"> AADHAAR ID </label>
                  <div class="col-md-8">
                    <input class="form-control" name="p1" value="<?php echo $data['candidateid']; ?>" type="text" readonly >
                  </div>
                </div>
				                
				 <div class="form-group row">
                  <label class="control-label col-md-3">VOTE SECURED</label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['count(*)']; ?>" type="text" readonly >
                  </div>
                </div>
