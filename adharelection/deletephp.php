          ...
          <div class="col-lg-12">
            ...
            <div class="bs-component">
              <div class="alert alert-dismissible alert-warning">
                ...
                <h4>Warning!</h4>
                <p>Once you Cancel the tender you may not abel to partcipate again </p>
               <p class="bs-component">
			   <form class="row"  action="userdb3" method="post"> 
					<table><tr><td>Department ID</TD>
              ...
              <button class="btn btn-primary btn-lg btn-block" type="submit"  >Cancel Tender</button>
			  </form>
            </p>
			  </div>
            </div>
