...
<html lang="en">
 ...
 error_reporting(0);
  ...
  if(mysqli_num_rows(  $query) > 0){
    echo "<div class='form'><h3>!!!!!!!!!!! user name already exist please user other.</h3><br/>Click here to try again <a href='govtregistration.php'>Register</a></div>";
	
}else{
        $query = "INSERT into `doctor` (username, password, email, trn_date) VALUES ('$username', '".md5($password)."', '$email', '$trn_date')";
        $result = mysqli_query($con,$query);
}
        if($result){
            echo "<div class='form'><h3>You are registered successfully.</h3><br/>Click here to <a href='govtlogin.php'>Login</a></div>";
        }
    }else{
?>
    <!-- Navbar-->
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>Government Register</h1>
...
<h1>Registration</h1>
  <div class="form">
<form name="doctorregistration" action="" method="post">
<input type="text" name="username" placeholder="Username" required />  <br></br>
<input type="email" name="email" placeholder="Email" required />  <br></br>
<input type="password" name="password"  id="password" placeholder="Password" required />  <br></br>
<input type="password" name="password"   id="confirm_password" placeholder="Confirm Password" required />  <br></br>
<script>
