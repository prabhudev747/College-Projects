  ...
  <?php
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: chartinfo.php"); // Redirect user to index.php
            }else{
...
?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="http://localhost/pocketclinic/index.html">Pocket Clinic</a>
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>ADMIN LOGIN</h1>
