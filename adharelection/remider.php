  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Reminder</span><i class="treeview-indicator fa fa-angle-right"></i></a>
       ...
       <li><a class="app-menu__item active" href="treatmenthistory.php"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Treatment history</span></a></li>
        <li><a class="app-menu__item" href="reminder.php"><i class="app-menu__icon fa fa-th-list"><span class="app-menu__label">Near by Search</span></a></li>
        <li><a class="app-menu__item" href="nearby.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Near by Search</span></a></li>
...
$result = mysql_query("SELECT * from treatmentinfo,doctorprofile where treatmentinfo.pid = '$a' and treatmentinfo.doctorid=doctorprofile.doctorid"); 
...
?>
  ...
  <div class="clearix"></div>
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">MEDICINE</h3>
            <div class="tile-body">
