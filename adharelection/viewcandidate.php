...
.</h5></p>
		 ...
		 <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Candidate profile</h3>
            <div class="tile-body">
			<img src="img/<?php echo $data['img']; ?>" alt="Find Right Path" width="100" height="100">

                <div class="form-group row">
                  <label class="control-label col-md-3">CANDIDATE NAME </label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['cname']; ?>" type="text" readonly >
                  </div>
                </div>
				<div class="form-group row">
                  <label class="control-label col-md-3">PARTY</label>
                  <div class="col-md-8">
                    <input class="form-control" value="<?php echo $data['cparty']; ?>" type="text"  readonly>
                  </div>
                </div>
				<div class="form-group row">
				 ...
				 <form class="form-horizontal" action="deletecandi.php" method="post">
				<div class="form-group row">
