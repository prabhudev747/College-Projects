...
?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="http://localhost/pocketclinic/">ADHAR-ELE</a>
		...
		<div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
			  ...
			  <br>
              <b>"Be patient when it seems things are not going right and may never be right again. Accept that what is yours will come to you in the right way at just right movement."</b>
			  <br>
			  <br>
			  <br><br>
			  <b> "Always remember that your present situation is not your final destination The best is yet to come."<b><br><br> <br>
            </div>
          </div>
        </div></DIV>
		</div>
