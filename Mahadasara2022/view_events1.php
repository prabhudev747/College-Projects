...
<body>
  <center>  <legend style=" color: #FF5733;font-size:20px;" >Events</legend></center><br><br>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                               ...
                               $sql="select ename,no_of_participants,gender,name,bname,phoneno,event_rules_path from ravi where event_type_id='$event_type_id'";
                               ...
                               // echo "<tr><td>".$query."</td></tr>";
                                ...
                                while ($r=mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                       ...
                                       <td><a href='<?php echo $r[6]; ?>' target='_blank'>click here</a></td>
