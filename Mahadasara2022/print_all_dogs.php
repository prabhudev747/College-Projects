                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                $sql="select o_id,o_name,file1,file2,o_place,d_name,d_breeds,file3,o_phone from dogshow";
                            //  echo $sql;
                                $query=mysqli_query($con,$sql);
...
-->                                    <tr>
                                       ...
                                       $o_phone=$r['o_phone'];
                                       $ownerinfo="";
                                        $ownerinfo.="Name: ".$r['o_name']."<br>Phone:". $o_phone."<br>Place: ".$o_place;
                                        
                                        echo $ownerinfo; ?></td>
                                           
                                          <td><img src="<?php  echo $r['file3']?>" width="80" height="100"></td>
                                        <td><?php echo "Dog Name:".$r['d_name']."<br> Dog Breed:".$r['d_breeds']; ?></td>
