...
<div class="form-group">
  ...
  <span class="help-block">Type your Valid Email id</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-2">
    ...
    <span class="help-block">Use atleast 5 characters</span>
  </div>
</div>
 ...
 if(mysqli_num_rows($query)==1)
 {
    ...
    $branchid=$r['branchid'];
       ...
       // $branchid=$rows['branchid'];
        ...
        echo "<script>window.location.replace('dept_cohome.php')</script>";
    }
