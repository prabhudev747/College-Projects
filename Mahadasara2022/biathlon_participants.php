...
{
   // alert('str='+str);
    window.location.replace('print_all_biathlon.php');
//window.print();
}
    </script>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <th>Sl.No.</th>
                                    ...
                                    <th>Participant-1</th>
                                     <th>Photo</th>                                      
                                    <th>Participant-2</th>
                                    <th>Contact Info</th>                                  <th>Email Info</th>  
                                    <!--<th>Place</th>-->
                                    <!--<th>contactno</th>-->
                             ...
                             $slno=0;
                                //$sql="select ename,gender,name,bname,email,phoneno,email1,email2 from v7 where event_type_id='$event_type_id'";
                                $sql="select bid,name1,file1,place1,name2,file2,place2,phoneno1,phoneno2,email1,email2 from biathlon order by bid";
                            //  echo $sql;
                                $query=mysqli_query($con,$sql);
